...
class GoogleMapsFlutterIOS extends GoogleMapsFlutterPlatform {
  ...
  static PlatformCircle _platformCircleFromCircle(Circle circle) {
    return PlatformCircle(
      ...
      fillColor: PlatformColor(
        red: circle.fillColor.red / 255,
        green: circle.fillColor.green / 255,
        blue: circle.fillColor.blue / 255,
        alpha: circle.fillColor.alpha / 255,
      ),
      strokeColor: PlatformColor(
        red: circle.strokeColor.red / 255,
        green: circle.strokeColor.green / 255,
        blue: circle.strokeColor.blue / 255,
        alpha: circle.strokeColor.alpha / 255,
      ),
  ...
  static PlatformPolygon _platformPolygonFromPolygon(Polygon polygon) {
    ...
    return PlatformPolygon(
      ...
      fillColor: PlatformColor(
        red: polygon.fillColor.red / 255,
        green: polygon.fillColor.green / 255,
        blue: polygon.fillColor.blue / 255,
        alpha: polygon.fillColor.alpha / 255,
      ),
      ...
      holes: holes,
      strokeColor: PlatformColor(
        red: polygon.strokeColor.red / 255,
        green: polygon.strokeColor.green / 255,
        blue: polygon.strokeColor.blue / 255,
        alpha: polygon.strokeColor.alpha / 255,
      ),
  ...
  static PlatformPolyline _platformPolylineFromPolyline(Polyline polyline) {
    ...
    return PlatformPolyline(
      ...
      color: PlatformColor(
        red: polyline.color.red / 255,
        green: polyline.color.green / 255,
        blue: polyline.color.blue / 255,
        alpha: polyline.color.alpha / 255,
      ),
